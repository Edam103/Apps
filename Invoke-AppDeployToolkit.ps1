...
function Install-ADTDeployment
{
    ...
    Set-ADTRegistryKey -Key "HKLM\SOFTWARE\InstalledApps\ojdkbuild open-source project_ojdkbuild OpenJDK 17.0.3.0.6-1_17.0030.6.1"
}
...
function Uninstall-ADTDeployment
{
    ...
    #ojdkbuild OpenJDK 17_17.0030.6.1_X64_wix_en-US.msi; ProductName: ojdkbuild OpenJDK 17.0.3.0.6-1; ProductVersion: 17.0030.6.1
    Start-ADTMsiProcess -Action 'Uninstall' -ProductCode '{85C97C32-CFB2-43E7-9540-8040220D1E94}'
    ...
    ## Master Wrapper detection
    Remove-ADTRegistryKey -Key "HKLM\SOFTWARE\InstalledApps\ojdkbuild open-source project_ojdkbuild OpenJDK 17.0.3.0.6-1_17.0030.6.1"
}
...
function Repair-ADTDeployment
{
    ...
    #ojdkbuild OpenJDK 17_17.0030.6.1_X64_wix_en-US.msi; ProductName: ojdkbuild OpenJDK 17.0.3.0.6-1; ProductVersion: 17.0030.6.1
    Start-ADTMsiProcess -Action 'Repair' -ProductCode '{85C97C32-CFB2-43E7-9540-8040220D1E94}'
